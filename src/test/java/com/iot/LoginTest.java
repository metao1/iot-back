...
public class LoginTest extends BaseTest {
    ...
    protected void extendSetup() {
        accountCredential.setUsername("admin@gmail.com");
        accountCredential.setPassword("mehrdad");
        initializeMvc();
    }

    @Test
    public void testLoginIsOK() throws Exception {
        MockHttpServletResponse result = mvc.perform(post(createURLWithPort("api/authenticate"))
